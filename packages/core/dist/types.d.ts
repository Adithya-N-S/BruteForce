 ...
 */
export type EvidenceEdgeType = 'owns_pct' | 'director_of' | 'registered_at' | 'consignee_on' | 'shipper_on' | 'agent_for' | 'listed_sanctioned' | 'same_as';
/**
 ...
 */
export type ExtractionMethod = 'registry_filing' | 'bill_of_lading_field' | 'sanctions_list_entry' | 'entity_resolution' | 'manual_seed' | 'co_consignee_derivation';
/**
