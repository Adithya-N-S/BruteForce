...
import { DuplicateEdgeError, DuplicateEntityError, EdgeNotFoundError, EntityNotFoundError, } from './errors.js';
// ─────────────────────────────────────────────────────────────────────────────
// GraphManager
// ─────────────────────────────────────────────────────────────────────────────
/**
...
export class GraphManager {
    ...
    toEvidenceGraph() {
        ...
        const edges = this.graph.mapEdges((edgeId, attrs, source, target) => ({
            id: edgeId,
            from: source,
            to: target,
            ...attrs,
